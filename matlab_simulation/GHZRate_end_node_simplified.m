function rateGHZ = GHZRate_end_node_simplified(LA, LB, LC, sigGKP, etas, etam, etad, etac, Lcavity, kA, kB, kB2, kC, v, N)
...
parfor i = 1:N
    logErrInner = UW3_InnerLeaves_end_node_simplified(LAB, sigGKP, etas, etam, etad, etac, Lcavity, numMatchedOuterLeaves, ErrProbVec, PerrorQA, PerrorPA, PerrorQB, PerrorPB);
...
parfor i = 1:N
    logErrInner = UW3_InnerLeaves_end_node_simplified(LBC, sigGKP, etas, etam, etad, etac, Lcavity, numMatchedOuterLeaves2, ErrProbVec, PerrorQC, PerrorPC, PerrorQB2, PerrorPB2);
...
parfor i = 1:N
    logErrEndNode = UW3_end_node_swapping_simplified(L, sigGKP, etas, etam, etad, etac, Lcavity, k, ErrProbVec);
