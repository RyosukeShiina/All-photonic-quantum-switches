...
%   results = runtests('TEST_map_swapping_results_to_ghz_pauli_operator_probabilities.m');
...
rng(1);
results0 = map_swapping_results_to_ghz_pauli_operator_probabilities( ...
...
rng(2);
resultsK = map_swapping_results_to_ghz_pauli_operator_probabilities( ...
...
rng(3);
resultsL1 = map_swapping_results_to_ghz_pauli_operator_probabilities( ...
    LA1, LB1, LC1, sigGKP, etas, etam, etad, etac, Lcavity, kA, kB, kC, v, N);

rng(4);
resultsL2 = map_swapping_results_to_ghz_pauli_operator_probabilities( ...
...
rng(5);
resultsSig1 = map_swapping_results_to_ghz_pauli_operator_probabilities( ...
    LA, LB, LC, sig1, etas, etam, etad, etac, Lcavity, kA, kB, kC, v, N);

rng(6);
resultsSig2 = map_swapping_results_to_ghz_pauli_operator_probabilities( ...
...
rng(7);
resultsHet = map_swapping_results_to_ghz_pauli_operator_probabilities( ...
