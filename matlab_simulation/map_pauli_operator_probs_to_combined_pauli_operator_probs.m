function combinedPauliOperatorResults = map_pauli_operator_probs_to_combined_pauli_operator_probs(ghzPauliOperatorResults)
...
if isempty(pauliTable)
    ...
    if numSourceOperators ~= 24 || numQubits ~= 3
...
for sourceIndex = 1:numSourceOperators
    ...
    if ~isscalar(sourceProb) || ~isnumeric(sourceProb) || ~isfinite(sourceProb)
