function [Xerr, Zerr] = inner_leaves_swapping_and_construction(L0, sigGKP, etas, etam, etad, etac, Lcavity, k, v, N)

%{

[Abstract]

This function outputs the error probabilities in the Z and X bases for a single segment for (1) Construction of Elementary Entangled Bell Pairs and (3) Inner-Leaves Swapping.
