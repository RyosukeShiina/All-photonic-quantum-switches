function RateList = GHZRateList_Distance(LA, LB, LC, sigGKP, etas, etam, etad, etac, Lcavity, k, v, N)

%FIG1
%GHZRateList(9, 1, 1, 0.12, 0.995, 0.999995, 0.9975, 0.99, 2, i, 0.3, 1000)



tic;

SingleResults_all = SingleResults_from_ESs_Distance(LA, LB, LC, sigGKP, etas, etam, etad, etac, Lcavity, k, v, N);
